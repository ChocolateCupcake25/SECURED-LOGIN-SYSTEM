...
firebase = firebase.FirebaseApplication("https://d-login-system-598f4-default-rtdb.firebaseio.com/",None)
...
def login_window():
    ...
    login_window.configure(bg="darkorchid")
    ...
    log_heading_label = Label(login_window, text="Log In" ,fg="DarkGoldenrod1", font = 'arial 18 bold',bg="darkorchid")
    log_heading_label.place(relx=0.5,rely=0.2, anchor=CENTER)
    
    login_username_label = Label(login_window, text="Username : " , fg="DarkGoldenrod1",font = 'arial 13',bg="darkorchid")
    ...
    login_password_label = Label(login_window, text="Password : " , font = 'arial 13',bg="darkorchid",fg="DarkGoldenrod1")
    ...
    btn_login = Button(login_window, text="Log In" , font = 'arial 13 bold' , command=login, relief=FLAT,bg="DarkOrchid4",fg="DarkGoldenrod1")
